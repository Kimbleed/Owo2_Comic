...
/**
    ...
    public void setup(AttributeSet attrs)
    {
        ...
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.ToggleButton_borderWidth2, borderWidth);
        defaultAnimate = typedArray.getBoolean(R.styleable.ToggleButton_mAnimate, defaultAnimate);
        toggleOn = typedArray.getBoolean(R.styleable.ToggleButton_toggleOn, toggleOn);
        typedArray.recycle();
